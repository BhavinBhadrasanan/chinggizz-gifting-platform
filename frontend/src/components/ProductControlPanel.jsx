...
export default function ProductControlPanel({
  ...
  return (
    <div className="fixed top-20 sm:top-24 right-2 sm:right-6 z-50 animate-slide-in-right max-w-[calc(100vw-1rem)] sm:max-w-none">
      ...
      <div className="relative">
        ...
        {/* Main Panel */}
        <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl p-3 sm:p-5 w-72 sm:w-80">
          {/* Header */}
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h3 className="text-white font-bold text-sm sm:text-lg truncate max-w-[120px] sm:max-w-none">{selectedItem.name}</h3>
                <p className="text-white/70 text-[10px] sm:text-xs hidden sm:block">Use controls to adjust position</p>
              </div>
            </div>
            ...
            <button
              onClick={onClose}
              className="glass-button w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center hover:bg-red-500/20 transition-all duration-300"
            >
          ...
          <div className="flex flex-col gap-2 sm:gap-4">
            ...
            <div className="flex flex-col items-center gap-1 sm:gap-2">
              <p className="text-white/70 text-[10px] sm:text-xs font-semibold mb-0.5 sm:mb-1">MOVE</p>
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              <p className="text-white/70 text-[10px] sm:text-xs font-semibold mb-0.5 sm:mb-1 text-center">ACTIONS</p>
              ...
              {selectedItem.rotation?.needsRotation && (
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-semibold">Rotate Direction</span>
                </button>
              )}

...
# Set Supabase environment variables (using direct connection port 5432)
...
$env:SPRING_DATASOURCE_URL="jdbc:postgresql://aws-0-ap-southeast-1.pooler.supabase.com:5432/postgres"
